...
class VicePresidentPage extends StatefulWidget {
  final String name;
  ...
  @override
  _VicePresidentPageState createState() => _VicePresidentPageState();
}

class _VicePresidentPageState extends State<VicePresidentPage> {
  ...
  Future<List<DocumentSnapshot>> getUsersList() async {
    QuerySnapshot querySnapshot = await _usersCollectionReference
        .where('position', isEqualTo: 'Vice President')
        .getDocuments();
