...
class SocialDirectorPage extends StatefulWidget {
  final String name;
  final String photoUrl;
  final bool hasVoted5;
  final String uid;

  const SocialDirectorPage({
    Key key,
    @required this.name,
  ...
  @override
  _SocialDirectorPageState createState() => _SocialDirectorPageState();
}

class _SocialDirectorPageState extends State<SocialDirectorPage> {
  ...
  Future<List<DocumentSnapshot>> getUsersList() async {
    QuerySnapshot querySnapshot = await _usersCollectionReference
        .where('position', isEqualTo: 'Social Director')
        .getDocuments();
