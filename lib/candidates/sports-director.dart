...
class SportsDirectorPage extends StatefulWidget {
  final String name;
  final String photoUrl;
  final bool hasVoted7;
  final String uid;

  const SportsDirectorPage({
    Key key,
    @required this.name,
  ...
  @override
  _SportsDirectorPageState createState() => _SportsDirectorPageState();
}

class _SportsDirectorPageState extends State<SportsDirectorPage> {
  ...
  Future<List<DocumentSnapshot>> getUsersList() async {
    QuerySnapshot querySnapshot = await _usersCollectionReference
        .where('position', isEqualTo: 'Sports Director')
        .getDocuments();
